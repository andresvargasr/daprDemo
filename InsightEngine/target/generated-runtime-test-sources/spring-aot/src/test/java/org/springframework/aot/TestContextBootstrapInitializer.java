...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.insightengine.InsightEngineApplicationTests", () -> new AotSpringBootConfigContextLoader(InsightEngineApplicationTestsContextInitializer.class));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.insightengine.InsightEngineApplicationTests", InsightEngineApplicationTestsContextInitializer.class);
    return entries;
  }
}
