...
import com.example.insightengine.InsightEngineApplication;
...
/**
 * AOT generated context for {@code InsightEngineApplicationTests}.
 */
public class InsightEngineApplicationTestsContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("insightEngineApplication", InsightEngineApplication.class)
        .instanceSupplier(InsightEngineApplication::new).register(beanFactory);
    org.springframework.boot.autoconfigure.InsightEngineApplicationTestsContextInitializer.registerAutoConfigurationPackages_BasePackages(beanFactory);
    ...
    org.springframework.boot.context.properties.InsightEngineApplicationTestsContextInitializer.registerConfigurationPropertiesBinder_Factory(beanFactory);
    org.springframework.boot.context.properties.InsightEngineApplicationTestsContextInitializer.registerConfigurationPropertiesBinder(beanFactory);
    ...
    org.springframework.boot.autoconfigure.gson.InsightEngineApplicationTestsContextInitializer.registerGsonAutoConfiguration_standardGsonBuilderCustomizer(beanFactory);
    ...
    org.springframework.boot.sql.init.dependency.InsightEngineApplicationTestsContextInitializer.registerDatabaseInitializationDependencyConfigurer_DependsOnDatabaseInitializationPostProcessor(beanFactory);
