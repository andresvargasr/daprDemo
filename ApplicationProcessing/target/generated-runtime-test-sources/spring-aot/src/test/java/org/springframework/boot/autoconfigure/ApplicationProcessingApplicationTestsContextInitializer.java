...
public final class ApplicationProcessingApplicationTestsContextInitializer {
  public static void registerAutoConfigurationPackages_BasePackages(
    ...
    BeanDefinitionRegistrar.of("org.springframework.boot.autoconfigure.AutoConfigurationPackages", AutoConfigurationPackages.BasePackages.class)
        .instanceSupplier(() -> new AutoConfigurationPackages.BasePackages(new String[] { "com.example.applicationprocessing" })).customize((bd) -> bd.setRole(2)).register(beanFactory);
  }
}
