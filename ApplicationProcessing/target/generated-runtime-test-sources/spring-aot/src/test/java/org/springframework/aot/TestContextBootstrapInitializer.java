...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.applicationprocessing.ApplicationProcessingApplicationTests", () -> new AotSpringBootConfigContextLoader(ApplicationProcessingApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.applicationprocessing.ApplicationProcessingApplicationTests", ApplicationProcessingApplicationTestsContextInitializer.class);
    return entries;
  }
}
