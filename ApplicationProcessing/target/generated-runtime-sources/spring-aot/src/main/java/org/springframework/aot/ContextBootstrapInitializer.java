...
public class ContextBootstrapInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("com.example.applicationprocessing.ApplicationProcessingApp", ApplicationProcessingApp.class)
    ...
    io.dapr.springboot.ContextBootstrapInitializer.registerDaprBeanPostProcessor(beanFactory);
